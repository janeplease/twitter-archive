...
public class GetLikes {
    ...
    public static void writeDataInFile(Get2UsersIdLikedTweetsResponse response, String filename) {
        try {
            FileWriter fw = new FileWriter("D:\\Projects\\TwitterJavaSDKBasic2\\data\\" + filename, true);
        ...
        do {
            try{
                ...
                result = apiInstance.tweets().usersIdLikedTweets(userId)
                        ...
                        .tweetFields(GetLikes.getTweetFields())
                        .expansions(GetLikes.getExpansions())
                        .mediaFields(GetLikes.getMediaFields())
                        .pollFields(GetLikes.getPollFields())
//                        .userFields(com.example.TwitterJavaSDKBasic2.GetLikes.getUserFields())
                        .placeFields(GetLikes.getPlaceFields())
                        .execute();
                if(result!=null &&
                        result.getData()!=null)
                    numTotalLikes = numTotalLikes + result.getData().size();
                GetLikes.writeDataInFile(result, "LikedTweets"+numTotalLikes + ".txt");
...
//                    break;
        ...
        while(numberOfCalls<75 && result.getMeta().getNextToken()!=null);
    ...
    public void getLikesByUserId(TwitterApi apiInstance, String userId) {
        ...
        directoryPreparation.clearDirectory();
